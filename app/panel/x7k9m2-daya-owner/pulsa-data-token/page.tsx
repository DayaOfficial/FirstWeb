    ...
    <div className="space-y-8">
      <div>
        <h2 className="text-2xl lg:text-3xl font-bold text-on-surface tracking-tight font-[family-name:var(--font-heading)] flex items-center gap-3">
          <Smartphone size={28} className="text-primary" /> Pulsa, Data & Token
        </h2>
        <p className="text-sm text-on-surface-variant mt-1">Kelola produk pulsa, paket data, dan token listrik.</p>
      </div>
      ...
      <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/20 shadow-soft p-12 text-center">
        ...
        <p className="text-sm text-on-surface-variant mb-6 max-w-md mx-auto">
          Fitur ini sedang dalam pengembangan. Sementara itu, Anda dapat mengelola produk pulsa, data, dan token melalui halaman Produk umum.
        </p>
        <Link href="/panel/x7k9m2-daya-owner/produk"
          className="inline-flex items-center gap-2 px-6 py-3 rounded-full gradient-primary text-white font-semibold text-sm shadow-md hover:opacity-90 transition-all">
