  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-on-surface-variant mt-1">Kelola produk aplikasi premium (Netflix, Spotify, YouTube, dll).</p>
      </div>
      <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/20 shadow-soft p-12 text-center">
        ...
        <p className="text-sm text-on-surface-variant mb-6 max-w-md mx-auto">Fitur ini sedang dalam pengembangan. Kelola produk App Premium melalui halaman Produk umum.</p>
